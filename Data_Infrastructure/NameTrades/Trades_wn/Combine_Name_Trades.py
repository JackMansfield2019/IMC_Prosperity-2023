...
with open('trades_round_4_day_1_wn.csv', mode='r') as csv_file:
...
with open('trades_round_4_day_2_wn.csv', mode='r') as csv_file:
    spamreader = csv.reader(csv_file, delimiter=' ', quotechar='|')
    line_count = 0
    for row in spamreader:
        if line_count == 0:
...
adder = trades[-1][0]
with open('trades_round_4_day_3_wn.csv', mode='r') as csv_file:
    spamreader = csv.reader(csv_file, delimiter=' ', quotechar='|')
    line_count = 0
    for row in spamreader:
        if line_count == 0:
...
with open("Combined_Round4.csv", 'w', encoding='UTF8', newline='') as f:
