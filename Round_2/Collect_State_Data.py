...
def pina_colada_strategy(self: Strategy, state: TradingState) -> None:
    ...
    print("PINA: "+str(highest_bid) + " " + str(lowest_ask) + " " + str(0) + " " + str(0) + " " + str(0) + " " + str(0), end=" ")
    
def coconuts_strategy(self: Strategy, state: TradingState) -> None:
    highest_bid = max(state.order_depths[self.symbol].buy_orders.keys())
    lowest_ask = min(state.order_depths[self.symbol].sell_orders.keys())
    print("COCO: "+str(highest_bid) + " " + str(lowest_ask) + " " + str(0) + " " + str(0) + " " + str(0) + " " + str(0))

# Strategies to run
strategies: List[Strategy] = [
    Strategy("PINA_COLADAS", 300, pina_colada_strategy),
    Strategy("COCONUTS", 600, coconuts_strategy)
]
