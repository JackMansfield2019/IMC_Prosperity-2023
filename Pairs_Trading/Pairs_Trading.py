...
# The pairs trading strategy will also take in a symbol for the index to find the correlation with
def pairsTradingStrategy(self: Strategy, state: TradingState, index: Symbol) -> None:
